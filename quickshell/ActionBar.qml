...
PanelWindow {
    ...
    property int  battPct:      0       // <-- Added battery percentage
    property bool battCharging: false   // <-- Added charging status flag
    property var  wsData:       []
    ...
    Rectangle {
        ...
        Row {
            ...
            Text { text: clockRow.t; color: "#D9CCCC"; font.family: "Google Sans"; font.pixelSize: 14; font.weight: Font.Medium; anchors.verticalCenter: parent.verticalCenter }
            Text { text: "|"; color: "#A68C8A"; font.family: "Google Sans"; font.pixelSize: 12; anchors.verticalCenter: parent.verticalCenter }
            Text { text: clockRow.d; color: "#D9CCCC"; font.family: "Google Sans"; font.pixelSize: 14; font.weight: Font.Medium; anchors.verticalCenter: parent.verticalCenter }
        }
    }
        ...
        RowLayout {
            ...
            Repeater {
                ...
                Rectangle {
                    ...
                    color: foc ? "#A68C8A" : (occ ? "#40170E" : "#0D0D0D")
                    border.width: 0
    ...
    Rectangle {
        ...
        Row {
            ...
            Item {
                ...
                Image {
                    ...
                    source: trayToggle._hov
                        ? "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%23D9CCCC' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='m10 16 4-4-4-4'/><path d='M3 12h11'/><path d='M3 8V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3'/></svg>"
                        : "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24' fill='none' stroke='%23D9CCCC' stroke-width='2' stroke-linecap='round' stroke-linejoin='round'><path d='M10 12h11'/><path d='m17 16 4-4-4-4'/><path d='M21 6.344V5a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-1.344'/></svg>"
                }
                MouseArea {
            ...
            // ── Battery Pill ──────────────────────────────────────────
            TrayPill {
                valueText: win.battPct + "%"
                accentColor: win.battCharging ? "#D9CCCC" : (win.battPct <= 20 ? "#40170E" : "#A68C8A")
                onClicked: win.statsVisible = !win.statsVisible
                iconSvg: {
                    if (win.battCharging) return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="10" x="2" y="7" rx="2" ry="2"/><line x1="22" x2="22" y1="11" y2="13"/><polyline points="10 10 8 13 14 13 12 16"/></svg>'
                    if (win.battPct <= 20) return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="10" x="2" y="7" rx="2" ry="2"/><line x1="22" x2="22" y1="11" y2="13"/><line x1="6" x2="6" y1="10" y2="10"/></svg>'
                    return '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="16" height="10" x="2" y="7" rx="2" ry="2"/><line x1="22" x2="22" y1="11" y2="13"/></svg>'
                }
            }

            TrayPill { valueText: win.cpuPct+"%"; accentColor: "#A68C8A"
                onClicked: win.statsVisible = !win.statsVisible
            ...
            TrayPill { valueText: win.ramGb.toFixed(1)+"G"; accentColor: "#A68C8A"
                onClicked: win.statsVisible = !win.statsVisible
            ...
            TrayPill {
                ...
                accentColor: win.volMute ? "#40170E" : "#A68C8A"
                iconSvg: {
